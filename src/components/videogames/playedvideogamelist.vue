...
import PlayedVideoGameListItem from './playedvideogamelistitem.vue'
  ...
  methods: {
    init: function () {
      ...
      if (this.isOnline) {
        ...
        this.loading = false
        this.videoGames = this.$offlineStorage.get('videoGamesPlayed')
        this.allVideoGames = this.videoGames
        this.initPages()
      }
    },
    ...
    deleteThisRow: function (index) {
      this.videoGamesPage.splice(index, 1)
    },
