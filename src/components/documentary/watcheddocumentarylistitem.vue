        ...
        <b-col sm="6">
          ...
          >
            <b-card-text>
              ...
              <h6> 🎞 {{ parseDate(documentary.UserGM.consumedDate) }} </h6>
            </b-card-text>
            <b-card-text>
            ...
            <b-card-text>
              <b-button
                variant="success"
                @click="$emit('delete-row'); markAsUnwatchedDocumentary(documentary)"
              >
...
export default {
  name: 'WatchedDocumentaryListItem',
  ...
  methods: {
    markAsUnwatchedDocumentary: function (documentary) {
      axios.patch('http://192.168.1.90:3000/api/documentaries/' + documentary.Documentary.id + '/unwatched')
    },
