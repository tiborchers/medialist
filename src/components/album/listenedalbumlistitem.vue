        ...
        <b-col sm="6">
          ...
          >
            ...
            <b-card-text>
              <b-button
                variant="success"
                @click="markAsUnListenedAlbum(album)"
              >
                Desmarcar Como Escuchado
              </b-button>
            </b-card-text>
            <b-card-text>
              <b-button
...
export default {
  ...
  methods: {
    markAsUnListenedAlbum: function (album) {
      this.$emit('delete-row')
      axios.patch('http://192.168.1.90:3000/api/albums/' + album.Album.id + '/unlistened')
    },
